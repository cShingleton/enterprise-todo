<template>
  <v-list-item>
    <v-list-item-action>
      <v-checkbox :disabled="isChecked" v-model="isChecked" color="primary" @click="archiveTask"></v-checkbox>
    </v-list-item-action>

    <v-list-item-content>
      <v-list-item-title :class="[isChecked && 'grey--text', 'text-left']">{{ task.title }}</v-list-item-title>
    </v-list-item-content>
